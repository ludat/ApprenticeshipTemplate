  ...
  context 'with a valid user and a valid credit card' do
    ...
    context 'with an invalid password' do
      ...
      it 'return with an error' do
        get :purchases, {id: a_user.id, password: invalid_password}
    ...
    context 'with a cart with one book' do
      ...
      it 'returns an empty list of purchases' do
        get :purchases, {id: a_user.id, password: a_user.password}
